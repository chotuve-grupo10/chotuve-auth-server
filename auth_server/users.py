...
from auth_server.decorators.admin_user_or_is_same_user_required_decorator import admin_user_or_is_same_user_required
...
@admin_user_or_is_same_user_required
@cross_origin(allow_headers=['Content-Type', 'authorization'])
